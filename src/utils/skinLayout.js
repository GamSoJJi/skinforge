const SHARED_PARTS = [
  ...
  // 몸통
  { x: 20, y: 16, w: 8,  h: 4,  color: 'rgba(0,200,100,0.12)' },
  { x: 28, y: 16, w: 8,  h: 4,  color: 'rgba(0,200,100,0.08)' },
  { x: 16, y: 20, w: 24, h: 12, color: 'rgba(0,200,100,0.12)' },
  // 우다리
  { x: 0,  y: 16, w: 16, h: 16, color: 'rgba(200,50,50,0.12)' },
  // 좌다리
  { x: 16, y: 48, w: 16, h: 16, color: 'rgba(255,100,0,0.12)' },
  // 재킷
  { x: 16, y: 32, w: 24, h: 16, color: 'rgba(0,200,100,0.06)' },
  // 우다리 외피
  { x: 0,  y: 32, w: 16, h: 16, color: 'rgba(200,50,50,0.06)' },
  // 좌다리 외피
  { x: 0,  y: 48, w: 16, h: 16, color: 'rgba(255,100,0,0.06)' },
]

const NORMAL_ARM_PARTS = [
  // 우팔 (Steve 4px) — top/bottom + 4면
  { x: 44, y: 16, w: 4,  h: 4,  color: 'rgba(50,100,255,0.22)' },  // 손위
  { x: 48, y: 16, w: 4,  h: 4,  color: 'rgba(50,100,255,0.14)' },  // 손아래
  ...
  // 좌팔
  { x: 36, y: 48, w: 4,  h: 4,  color: 'rgba(180,0,255,0.22)' },   // 손위
  { x: 40, y: 48, w: 4,  h: 4,  color: 'rgba(180,0,255,0.14)' },   // 손아래
...
const SLIM_ARM_PARTS = [
  // 우팔 (사용 영역)
  { x: 44, y: 16, w: 3,  h: 4,  color: 'rgba(50,100,255,0.18)' },  // 상단
  { x: 47, y: 16, w: 3,  h: 4,  color: 'rgba(50,100,255,0.18)' },  // 하단
  { x: 40, y: 20, w: 4,  h: 12, color: 'rgba(50,100,255,0.18)' },  // 우측면
  { x: 44, y: 20, w: 3,  h: 12, color: 'rgba(50,100,255,0.18)' },  // 앞
  { x: 47, y: 20, w: 4,  h: 12, color: 'rgba(50,100,255,0.18)' },  // 좌측면
  { x: 51, y: 20, w: 3,  h: 12, color: 'rgba(50,100,255,0.18)' },  // 뒤
  // 우팔 미사용 픽셀
...
const SHARED_LABELS = [
  ...
  { name: '우다리',  x: 1,  y: 17, color: '#c83232' },
  { name: '좌다리',  x: 17, y: 49, color: '#c85000' },
  { name: '재킷',    x: 17, y: 33, color: '#009650' },
  { name: '우다리2', x: 1,  y: 33, color: '#c83232' },
  { name: '좌다리2', x: 1,  y: 49, color: '#c85000' },
]
